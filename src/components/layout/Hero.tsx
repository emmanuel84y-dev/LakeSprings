    ...
    <section className="relative">
      <div className="relative h-[78vh] min-h-[560px] w-full overflow-hidden md:h-[86vh]">
        ...
        <div className="container-lake relative flex h-full flex-col items-start justify-center pb-24 text-white">
          ...
          <h1 className="mt-3 animate-rise bg-gradient-to-b from-[#FFF3B0] via-[#D4AF37] to-[#8A6508] bg-clip-text font-display text-5xl font-medium leading-[1.05] text-transparent drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)] md:text-7xl">
            {name}
          </h1>
